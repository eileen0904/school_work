...
void magic (int n)// create a magic square of size n, n is odd
{
...
int main()
{
    ...
    magic(n);
    stop = clock();
    double spend_time = double(stop-start) / double(CLOCKS_PER_SEC);
    cout<<"The program takes "<<spend_time<<" sec"<<endl;
    cout<<"The average time of program is "<<spend_time/time<<" sec"<<endl;
}
